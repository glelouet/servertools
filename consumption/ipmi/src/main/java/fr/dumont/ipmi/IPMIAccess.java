...
public class IPMIAccess {
	...
	public double getWatt() throws IOException {
		return handleConsumptionDataToWatt(execute(
				BasicCommands.IPMI_GET_SENSOR, "System Level"));
	}
	...
	public String[][] getSensorsList() throws IOException {
		return handleSensorsDatasToList(execute(BasicCommands.IPMI_SENSOR_LIST));
	}
